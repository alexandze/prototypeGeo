...
public class MapDependencyContainerImpl: MapDependencyContainer {
    ...
    func makeFieldListStateObservable() -> Observable<FieldListState> {
        self.stateStore.makeObservable(transform: {(subscription: Subscription<AppState>) -> Subscription<FieldListState> in
            subscription
                .select { appState in
    ...
    func makeFieldListViewModel() -> FieldListViewModel {
        return FieldListViewModelImpl(fieldListState$: self.makeFieldListStateObservable(), fieldListInteraction: self.makeFieldListInteraction())
    }
    ...
    func makeCurrentFieldObservable() -> Observable<CulturalPracticeState> {
        self.stateStore.makeObservable(transform: {(subscription: Subscription<AppState>) -> Subscription<CulturalPracticeState> in
            subscription
                .select { appState in
    ...
    func makeCulturalPracticeViewModel() -> FieldCulturalPraticeViewModel {
        FieldCulturalPraticeViewModelImpl(fieldCulturalPracticeState$: self.makeCurrentFieldObservable(), fieldCulturalPracticeInteraction: self.makeCulturalPracticeInteraction())
    }
