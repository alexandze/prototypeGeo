...
enum Avaloir {
    ...
    static func getValues() -> [(Avaloir, String)] {
        [
            ...
            (Avaloir.captagePartiel, NSLocalizedString("Captage Partiel", comment: "Avaloir captage partiel")),
            (Avaloir.CaptageSystematique, NSLocalizedString("Captage systématique", comment: "Avaloir Captage systématique")),
        ]
    }
}
...
enum BandeRiveraine {
    ...
    static func getValues() -> [(BandeRiveraine, String)] {
        [
            (BandeRiveraine.pasApplique, NSLocalizedString("Ne s'applique pas", comment: "Bande riveraine ne s'applique pas")),
            (BandeRiveraine.inferieura1M, NSLocalizedString("Inférieur à 1m", comment: "Bande riveraine Inférieur à 1m")),
            (BandeRiveraine.de1A3M, NSLocalizedString("1 à 3m", comment: "Bande riveraine 4m et plus")),
            (BandeRiveraine.de4MEtPlus, NSLocalizedString("4m et plus", comment: "Bande riveraine 4m et plus"))
        ]
    }
}
...
enum PeriodeApplicationFumier {
    ...
    static func getValue() -> [(PeriodeApplicationFumier, String)] {
        [
            (PeriodeApplicationFumier.preSemi, NSLocalizedString("Pré-semi", comment: "Periode d'application du fumier Pré-semi")),
            (PeriodeApplicationFumier.postLevee, NSLocalizedString("Post-levée", comment: "Periode d'application du fumier Post-levée")),
            (PeriodeApplicationFumier.preSemi, NSLocalizedString("Automne hâtif", comment: "Periode d'application du fumier Automne hâtif")),
            (PeriodeApplicationFumier.preSemi, NSLocalizedString("Automne tardif", comment: "Periode d'application du fumier Automne tardif")),
        ]
    }
}
...
enum TravailSol {
    ...
    static func getValue() -> [(TravailSol, String)] {
        [
            (TravailSol.labourAutomneTravailSecondairePrintemps, NSLocalizedString("Labour à l'automne, travail secondaire au printemps", comment: "Travail du sol Labour à l'automne")),
            (TravailSol.chiselPulverisateurAutomneTravailSecondairePrintemps, NSLocalizedString("Chisel ou pulvérisateur à l'automne, travail secondaire au printemps", comment: "Travail du sol Chisel ou pulvérisateur à l'automne, travail secondaire au printemps")),
            (TravailSol.dechaumageAuPrintempsTravailSecondairePrintemps, NSLocalizedString("Déchaumage au printemps et travail secondaire au printemps", comment: "Travail du sol Déchaumage au printemps et travail secondaire au printemps")),
            (TravailSol.semiDirectOuBilons, NSLocalizedString("Semi direct ou bilons", comment: "Travail du sol Semi direct ou bilons")),
        ]
    }
}
