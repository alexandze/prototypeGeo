...
public class FarmerTableViewModel {
    ...
    let farmerTableViewControllerState$: Observable<FarmerTableViewControllerState>
    var disposableTableViewControllerState: Disposable?
    
    init(
        farmerTableViewInteraction: FarmerTableViewInteractions,
        farmerTableViewControllerState$: Observable<FarmerTableViewControllerState>
    ) {
        self.farmerTableViewInteraction = farmerTableViewInteraction
        self.farmerTableViewControllerState$ = farmerTableViewControllerState$
    }
    ...
    func initAddBarButton(viewController: UIViewController) {
        let barButton = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(addFarmer(_:)))
    ...
    @objc func addFarmer(_ barButtonItem: UIBarButtonItem) {
        ...
        //self.dispatchGoToFarmerAddViewController(farmerTableViewInteractions: self.farmerTableViewInteraction)
    }
    ...
    func susbcribeToTableViewControllerState(farmerTableViewController: FarmerTableViewController) {
        self.disposableTableViewControllerState = farmerTableViewControllerState$.subscribe(onNext: {
            self.setDataTableView(farmers: $0.farmers, sectionsFarmers: $0.sectionsFarmersFormated, farmerTableViewController: farmerTableViewController)
        })
    }
    ...
    func setDataTableView(farmers: [Farmer], sectionsFarmers: [Section<FarmerFormated>]?, farmerTableViewController: FarmerTableViewController ) {
