...
public class SelectFormCulturalPracticeViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    init(
        culturalPracticeFormViewModel: SelectFormCulturalPracticeViewModel,
        selectFormCulturalPracticeView: SelectFormCulturalPracticeView = SelectFormCulturalPracticeView()
    ) {
        self.selectFormCulturalPracticeViewModel = culturalPracticeFormViewModel
        self.selectFormCulturalPracticeView = selectFormCulturalPracticeView
